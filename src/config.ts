	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/chinachinese1/chinachinese1.github.io",
					external: true,
				...
				{
					name: "小鱼仔娱乐的QQ群",
					url: "https://qm.qq.com/q/Ac8JjEVQpa",
					external: true,
					icon: "fa6-brands:qq",
				},
				{
					name: "Fishyflicks服务器的QQ群",
					url: "https://qm.qq.com/q/xzn8nzme5O",
					external: true,
					icon: "fa6-brands:qq",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		...
		lang: "cn_ZH", // 设置 Twikoo 评论系统语言为英文
	},
};

export const announcementConfig: AnnouncementConfig = {
	title: "公告[手动更新]", // 公告标题
	content: "欢迎来到Fishyflicks官网！游玩请查看置顶动态！", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "欢迎来到Fishyflicks官网(≧∇≦)ﾉ", // 欢迎词
		touch: [
			"你在做什么？（￣︶￣）↗　",
			"别点啦w(ﾟДﾟ)w!",
			"HENTAI!",
		...
		close: "QWQ 关掉就回不来了啦！", // 关闭提示
		link: "https://space.bilibili.com/1481001535", // 关于链接
	},
};
