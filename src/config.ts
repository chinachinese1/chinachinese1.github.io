...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://fishyflicks.ggff.net/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-25", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		homeText: {
			...
			title: "七秒记忆，刚刚好笑", // 主页横幅主标题

			subtitle: [
				"现代化的博客网站",
				"第一时间获取动态！",
				"Phigros,Minecraft,原神,崩坏:星穹铁道...我全发这！",
				"本来无一物，何处惹尘埃?",
				"欢迎来打小鱼仔娱乐的博客！",
			],
			typewriter: {
